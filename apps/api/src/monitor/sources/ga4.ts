...
// 18.09.2026 добавлен Китай: 147 → 1204 сессии за месяц при вовлечённости 5,3 % —
// тот же почерк, что у сингапурского потока. Реальный китайский спрос к нам не идёт:
// в Search Console по zh-локали 6849 показов и 37 кликов, и те по чужим брендам.
