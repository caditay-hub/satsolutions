...
const CAT_NAMES: Record<string, Loc> = {
  ...
  "Беспроводные мосты": { uz: "Simsiz ko'priklar", en: "Wireless bridges", tr: "Kablosuz köprüler", zh: "无线网桥" },
  ...
  "Охранная сигнализация": { uz: "Qo'riqlash signalizatsiyasi", en: "Intruder alarm", tr: "Hırsız alarmı", zh: "防盗报警" },
  "Передача данных": { uz: "Ma'lumot uzatish", en: "Data transmission", tr: "Veri iletimi", zh: "数据传输" },
