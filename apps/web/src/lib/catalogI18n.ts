...
const CAT_NAMES: Record<string, Loc> = {
  ...
  "Охранно-пожарная": { ru: "Охранно-пожарные системы", uz: "Qoʻriqlash va yongʻin tizimlari", en: "Security & fire systems", tr: "Güvenlik ve yangın sistemleri", zh: "安防与消防系统" },
  ...
  "PT-камеры": { uz: "PT kameralar", en: "PT cameras", tr: "PT kameralar", zh: "PT摄像机" },
  ...
  "Считыватели и конвертеры": { uz: "Oʻqish qurilmalari va konverterlar", en: "Readers & converters", tr: "Okuyucular ve dönüştürücüler", zh: "读卡器与转换器" },
  ...
  "Пожарная безопасность": { uz: "Yongʻin xavfsizligi", en: "Fire safety", tr: "Yangın güvenliği", zh: "消防安全" },
  "Огнетушители": { uz: "Oʻt oʻchirgichlar", en: "Fire extinguishers", tr: "Yangın söndürücüler", zh: "灭火器" },
  ...
  "Программное обеспечение": { uz: "Dasturiy taʼminot", en: "Software", tr: "Yazılım", zh: "软件" },
  ...
  "Wi-Fi мосты": { uz: "Wi-Fi koʻpriklar", en: "Wi-Fi bridges", tr: "Wi-Fi köprüleri", zh: "Wi-Fi网桥" },
  ...
  "Беспроводные продукты": { uz: "Simsiz mahsulotlar", en: "Wireless products", tr: "Kablosuz ürünler", zh: "无线产品" },
  "Дисплеи и системы управления": { uz: "Displeylar va boshqaruv tizimlari", en: "Displays & control systems", tr: "Ekranlar ve kontrol sistemleri", zh: "显示屏与控制系统" },
  "HDCVI продукты": { uz: "HDCVI mahsulotlari", en: "HDCVI products", tr: "HDCVI ürünleri", zh: "HDCVI产品" },
  "Интеллектуальный транспорт": { uz: "Intellektual transport", en: "Intelligent transportation", tr: "Akıllı ulaşım", zh: "智能交通" },
  "Контроль доступа и учёт времени": { uz: "Kirish nazorati va ish vaqtini hisobga olish", en: "Access control & time attendance", tr: "Geçiş kontrolü ve mesai takibi", zh: "门禁与考勤" },
  "Охранная сигнализация": { uz: "Qoʻriqlash signalizatsiyasi", en: "Intruder alarm", tr: "Hırsız alarmı", zh: "防盗报警" },
  "Передача данных": { uz: "Maʼlumot uzatish", en: "Data transmission", tr: "Veri iletimi", zh: "数据传输" },
  "Сетевые продукты": { uz: "Tarmoq mahsulotlari", en: "Networking products", tr: "Ağ ürünleri", zh: "网络产品" },
  "Тепловизионные камеры": { uz: "Teplovizor kameralar", en: "Thermal cameras", tr: "Termal kameralar", zh: "热成像摄像机" },
  "Тепловизионные продукты": { uz: "Teplovizor mahsulotlari", en: "Thermal products", tr: "Termal ürünler", zh: "热成像产品" },
  "Прочее оборудование": { uz: "Butlovchi qismlar va aksessuarlar", en: "Components & Accessories", tr: "Bileşenler ve Aksesuarlar", zh: "配件与辅材" },
  "Комплектующие и аксессуары": { uz: "Butlovchi qismlar va aksessuarlar", en: "Components & Accessories", tr: "Bileşenler ve Aksesuarlar", zh: "配件与辅材" },
};
