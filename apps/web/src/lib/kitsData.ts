...
export const KITS: Kit[] = [
  {
    ...
    loc: {
      ru: {
        ...
        faq: [
          { q: "Можно ли поставить больше камер?", a: "Да, регистратор на 8 каналов — добавите ещё до 4 камер без замены оборудования. Цена пересчитывается по смете." },
          { q: "Сколько хранится архив?", a: "С диском 1 ТБ — около 2 недель записи 4 камер. Для месяца архива берите 2 ТБ (+~220 тыс. сум)." },
      ...
      uz: {
        ...
        includes: [
          "4 ta koʻcha IP-kamerasi 4 Mp (HiLook/Hikvision, IK-yoritish, IP67)",
          ...
          "Telefondan koʻrish (Hik-Connect) va bildirishnomalarni sozlash",
        ],
        mount: ["Muhandis chiqishi va nuqtalarni belgilash", "80 m gacha kabel yotqizish", "Kameralarni oʻrnatish va sozlash", "Ishga tushirish va oʻrgatish"],
        faq: [
          { q: "Koʻproq kamera qoʻysa boʻladimi?", a: "Ha, registrator 8 kanalli — uskunani almashtirmasdan yana 4 tagacha kamera qoʻshasiz. Narx smeta boʻyicha qayta hisoblanadi." },
          { q: "Arxiv qancha saqlanadi?", a: "1 TB disk bilan 4 kamera yozuvi ~2 hafta. Bir oylik arxiv uchun 2 TB oling (+~220 ming soʻm)." },
          { q: "Oʻrnatish qancha vaqt oladi?", a: "Oddiy hovli — bir ish kuni, telefon sozlamalari bilan birga." },
        ],
        cta: "1 kunda aniq smeta oling",
        priceLabel: `${f(4000000)} soʻmdan`,
      },
      en: {
        ...
        faq: [
          ...
          { q: "How long is footage stored?", a: "About 2 weeks for 4 cameras with 1 TB. For a month take 2 TB (+~220k UZS)." },
      ...
      tr: {
        ...
        faq: [
          ...
          { q: "Kayıt ne kadar saklanır?", a: "1 TB ile 4 kamera ~2 hafta. Bir ay için 2 TB alın (+~220 bin UZS)." },
      ...
      zh: {
        ...
        faq: [
          ...
          { q: "录像保存多久？", a: "1TB下4台约2周；存一个月请选2TB（约加22万苏姆）。" },
  ...
  },
  {
    ...
    loc: {
      ...
      uz: {
        title: "Doʻkon uchun videokuzatuv toʻplami",
        tagline: "Kassa, zal va kirish nazoratda: 4 kamera, 2 haftalik arxiv va egasi uchun masofaviy kirish.",
        audience: "Doʻkon, dorixona, kafe, salon: kassa zonasi, savdo zali, kirish va ombor.",
        includes: [
          "4 ta ichki/koʻcha IP-kamerasi 4 Mp (zal uchun keng burchak)",
        ...
        mount: ["Kassa/zal/kirish boʻyicha belgilash", "80 m gacha kabel", "Montaj va detektsiya sozlash", "Xodimlarni oʻrgatish"],
        faq: [
          { q: "Kassadagi pul koʻrinadimi?", a: "Kassa ustiga kamerani aniq yoʻnaltiramiz; kupyuralarni ajratish uchun 4 Mp va undan yuqori tavsiya etiladi — toʻplamga kiradi." },
          { q: "Bir ilovada bir nechta doʻkonni koʻrish mumkinmi?", a: "Ha, barcha nuqtalar bitta Hik-Connect akkauntiga qoʻshiladi." },
          { q: "Kechasi/dam olish kunlari ishlaysizmi?", a: "Montajni doʻkon ishlamaydigan soatlarga rejalashtiramiz — savdo toʻxtamaydi." },
        ],
        cta: "1 kunda aniq smeta oling",
        priceLabel: `${f(4000000)} soʻmdan`,
      },
  ...
  },
  {
    ...
    loc: {
      ...
      uz: {
        title: "Ofis uchun toʻplam: videokuzatuv + SKUD",
        tagline: "4 kamera va kirish eshigiga oʻqigichli elektron qulf — xavfsizlik va kirish nazorati birgalikda.",
        ...
        includes: [
          ...
          "Elektromagnit qulf, karta oʻqigich, chiqish tugmasi",
          "Kirish kartalari toʻplami (10 dona)",
          "Kabel, quvvat, dovodchik; telefondan sozlash",
        ],
        mount: ["Joylashuv loyihasi", "Korobda kabel trassalari", "Kamera va eshikka SKUD montaji", "Ishga tushirish, kartalar, oʻrgatish"],
        faq: [
          { q: "Ish vaqtini hisobga olishni qoʻshsa boʻladimi?", a: "Ha — oddiy oʻqigich oʻrniga biometrik terminal (Face ID) oʻrnatamiz, tabel yuklab olinadi; qoʻshimcha ~2,5 mln soʻmdan." },
          { q: "Svet oʻchsa nima boʻladi?", a: "Qulfni zaxira quvvat blokiga ulaymiz: eshik akkumulyatordan bir necha soat ishlaydi." },
          { q: "Montaj qancha davom etadi?", a: "Oddiy ofis — jamoa ishini toʻxtatmasdan 1–2 ish kuni." },
        ],
        cta: "1 kunda aniq smeta oling",
        priceLabel: `${f(5000000)} soʻmdan`,
      },
      en: {
  ...
  },
  {
    ...
    loc: {
      ...
      uz: {
        title: "Ombor uchun videokuzatuv toʻplami",
        tagline: "Qabul, joʻnatish va stellajlar uchun 8 kamera, bir oylik arxiv va bir nechta xodim uchun kirish.",
        audience: "Ombor, sex, baza: darvozalar, rampalar, yoʻlaklar, perimetr.",
        includes: [
          "8 ta IP-kamera 4 Mp (koʻcha va ichki, IK 30 m gacha)",
          "PoE bilan 8–16 kanalli IP-videoregistrator",
          "2 TB qattiq disk (bir oygacha arxiv)",
          "Kabel trassalari, shkaf, quvvat",
          "Rahbar va qoʻriqlash uchun telefondan kirish",
        ],
        mount: ["Ombor rejasi boʻyicha loyiha", "300 m gacha kabel, balandlik ishlari", "Montaj, sozlash, zona detektsiyasi", "Ishga tushirish va saqlash reglamenti"],
        faq: [
          { q: "Tizim 12–16 kamerani koʻtaradimi?", a: "Ha, registratorni kanal zaxirasi bilan tanlaymiz — asosni almashtirmasdan kengayasiz." },
          { q: "Yuklashni mashina raqamlari boʻyicha nazorat qilsa boʻladimi?", a: "Ha, darvozaga raqam taniydigan ANPR-kamera qoʻshiladi — ~3 mln soʻmdan." },
          { q: "Yuridik shaxs uchun shartnoma va aktlar bormi?", a: "Ha: shartnoma, QQS bilan schyot-faktura, aktlar va ijro sxemasi — toʻliq paket." },
        ],
        cta: "1 kunda aniq smeta oling",
        priceLabel: `${f(7500000)} soʻmdan`,
      },
      en: {
