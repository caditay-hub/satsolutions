          ...
          {bucket.map((tile, ci) => {
            ...
            return (
              ...
              >
                ...
                <span className="mt-2.5 flex items-center justify-center gap-1.5 text-center text-[16px] font-bold leading-snug text-slate-900 transition-colors group-hover:text-brand-700">
                  {tile.name}
