...
export function ScrollToTopButton({ label = "Наверх" }: { label?: string }) {
  ...
  return (
    <button
      ...
      className="fab-lift fixed bottom-24 right-5 z-[60] inline-flex h-12 w-12 items-center justify-center rounded-full border border-brand-200 bg-white text-brand-700 shadow-lg transition-colors hover:bg-brand-50 hover:text-brand-800"
    >
