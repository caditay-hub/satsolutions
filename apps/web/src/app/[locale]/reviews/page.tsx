...
const UI: Record<string, { title: string; subtitle: string; sectionTitle: string; empty: string; crumbHome: string; googleCta: string }> = {
  ...
  uz: { title: "Mijozlar sharhlari", subtitle: "Ishimizni baholang va SAT Solutions haqida mijozlar nima deyishini oʻqing.", sectionTitle: "Mijozlar nima deydi", empty: "Hozircha sharhlar yoʻq — birinchi boʻlib ishimizni yuqorida baholang.", crumbHome: "Bosh sahifa", googleCta: "Google Xaritada baholang" },
