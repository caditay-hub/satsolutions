...
const D: Record<string, {
  ...
  ru: {
    ...
    sections: [
      ...
      { h: "Гарантия", items: [
        "На всё оборудование действует гарантия производителя (от 1 года — точный срок указан в карточке товара и гарантийном талоне).",
      ...
      { h: "Как оформить возврат", items: [
        ...
        "Привезите товар по адресу: г. Ташкент, ул. Катта Дархон, 5 (Пн–Пт 09:00–18:00) или согласуйте забор курьером.",
      ]},
    ],
  ...
  uz: {
    ...
    intro: "Biz Oʻzbekiston Respublikasining «Isteʼmolchilarning huquqlarini himoya qilish toʻgʻrisida»gi qonuniga muvofiq ishlaymiz va quyidagi qaytarish shartlarini taqdim etamiz.",
    sections: [
      { h: "Sifatli tovarni qaytarish", items: [
        ...
        "Tovar ishlatilmagan, zavod qadoqlari, butlash, plombalar va tovar koʻrinishi saqlangan boʻlishi kerak.",
        "Xaridni tasdiqlovchi hujjat (chek, yuk xati, hisob-faktura) boʻlishi zarur.",
        "Pul mablagʻlari toʻlov amalga oshirilgan usulda 10 ish kuni ichida qaytariladi.",
      ]},
      { h: "Nuqsonli tovarni qaytarish va almashtirish", items: [
        ...
        "Nosozlik diagnostikasi Toshkentdagi servis markazimizda oʻtkaziladi.",
        "Nuqsonli tovarni almashtirish xarajatlarini SAT Solutions oʻz zimmasiga oladi.",
      ]},
      { h: "Kafolat", items: [
        "Barcha uskunalarga ishlab chiqaruvchi kafolati amal qiladi (1 yildan — aniq muddat tovar kartochkasida va kafolat talonida koʻrsatilgan).",
        "Kafolat va kafolatdan keyingi xizmat servis markazimizda bajariladi.",
      ]},
      { h: "Qaytarishni qanday rasmiylashtirish", items: [
        "Biz bilan bogʻlaning: +998 97 862 66 99 (qoʻngʻiroq, Telegram, WhatsApp) yoki sales@satsolutions.uz.",
        "Tovarni manzilga olib keling: Toshkent sh., Katta Darxon koʻchasi, 5 (Du–Ju 09:00–18:00) yoki kuryer olib ketishini kelishing.",
      ]},
    ],
    contact: "Qaytarish boʻyicha savollar: +998 97 862 66 99 · sales@satsolutions.uz",
  },
  en: {
    ...
    sections: [
      ...
      { h: "Warranty", items: [
        "All equipment carries the manufacturer's warranty (from 1 year — the exact term is stated on the product page and warranty card).",
      ...
      { h: "How to request a return", items: [
        ...
        "Bring the item to: 5 Katta Darxon street, Tashkent (Mon–Fri 9:00–18:00) or arrange courier pickup.",
      ]},
    ],
  ...
  tr: {
    ...
    sections: [
      ...
      { h: "Garanti", items: [
        "Tüm ekipmanlar üretici garantisi kapsamındadır (1 yıldan itibaren — kesin süre ürün sayfasında ve garanti belgesinde belirtilir).",
      ...
      { h: "İade talebi nasıl yapılır", items: [
        ...
        "Ürünü adresimize getirin: Katta Darxon caddesi 5, Taşkent (Pzt–Cum 09:00–18:00) veya kurye ile teslim alınmasını ayarlayın.",
      ]},
    ],
  ...
  zh: {
    ...
    sections: [
      ...
      { h: "保修", items: [
        "所有设备均享有制造商保修（1 年起，具体期限详见产品页面及保修卡）。",
        "保修及保修后服务由我们的服务中心提供。",
      ]},
      { h: "如何申请退货", items: [
        "请联系我们：+998 97 862 66 99（电话、Telegram、WhatsApp）或 sales@satsolutions.uz。",
        "将商品送至：塔什干市 Katta Darxon 街5号（周一至周五 9:00–18:00），或安排快递取件。",
      ]},
    ],
