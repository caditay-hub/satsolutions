...
const D: Record<string, {
  ...
  uz: {
    ...
    sections: [
      ...
      { h: "Kafolat", items: [
        "Barcha uskunalarga ishlab chiqaruvchi kafolati amal qiladi (1 yildan — aniq muddat tovar kartochkasida va kafolat talonida ko'rsatilgan).",
      ...
      { h: "Qaytarishni qanday rasmiylashtirish", items: [
        ...
        "Tovarni manzilga olib keling: Toshkent sh., Katta Darxon ko'chasi, 5 (Du–Ju 09:00–18:00) yoki kuryer olib ketishini kelishing.",
      ]},
    ],
