...
const COUNTRIES: Record<string, Country> = {
  tajikistan: {
    ...
    uz: { name: "Tojikiston", cities: "Dushanbe, Xoʻjand, Boxtar", delivery: "Toshkentdagi ombordan avtoyetkazish: Xoʻjandgacha 1–2 kun, Dushanbegacha 2–3 kun." },
...
const D: Record<string, Dict> = {
  ...
  uz: {
    metaTitle: (c) => `${c.uz.name}ga xavfsizlik uskunalari taʼminoti | SAT Solutions`,
    metaDesc: (c) => `Oʻzbekistondan ${c.uz.name}ga xavfsizlik tizimlari eksporti: Hikvision va Dahua videokuzatuv, SKUD, yongʻin tizimlari, MikroTik tarmoqlari — Toshkent omboridan 3000+ pozitsiya, eksport kontrakti, invoys, yetkazib berish. ${c.uz.cities}.`,
    h1: (c) => `${c.uz.name}ga xavfsizlik uskunalari taʼminoti`,
    intro: (c) => `SAT Solutions ${c.uz.name}dagi kompaniya va pudratchilarga xavfsizlik tizimlari va tarmoq uskunalarini yetkazadi: videokuzatuv, SKUD, yongʻin signalizatsiyasi, serverlar va tarmoqlar. Toshkentdagi omborimizdan joʻnatamiz — Hikvision, Dahua, ZKTeco, MikroTik, TP-Link, H3C dan 3000 dan ortiq pozitsiya mavjud. Eksport kontrakti va toʻliq hujjatlar paketi bilan ishlaymiz.`,
    whyTitle: "Nega bizdan xarid qilish kerak",
    why: (c) => [
      { t: "Ombor dengiz ortida emas, yonida", d: `${c.uz.delivery} Ombor pozitsiyalari toʻlov kunida joʻnatiladi — Xitoydan toʻgʻridan-toʻgʻri buyurtmadagi haftalab kutishga qarshi.` },
      { t: "Eksport kontrakti va hujjatlar", d: "TIF kontrakti, invoys, qadoqlash varagʻi va uskuna sertifikatlarini tayyorlaymiz. Toʻlov — kontrakt boʻyicha valyuta oʻtkazmasi." },
      { t: "24 soatda tanlov va KP", d: "Spetsifikatsiya, loyiha yoki oddiy vazifalar roʻyxatini yuboring — muhandis uskunani tanlaydi, analoglar taklif qiladi va bir sutkada KP qaytaradi." },
      { t: "Kafolat va qoʻllab-quvvatlash", d: "Kafolat majburiyatlari kontraktda belgilanadi; uskuna almashtirish — Toshkent orqali. Montajchilaringizga sozlash boʻyicha masofadan maslahat beramiz." },
    ],
    faqTitle: "Tez-tez soʻraladigan savollar",
    faq: (c) => [
      { q: `${c.uz.name}dan toʻlovni qanday qilish mumkin?`, a: "Eksport kontrakti tuzamiz, invoys chiqaramiz — toʻlov valyuta bank oʻtkazmasi bilan. Muntazam xaridlarga arizalar boʻyicha joʻnatmali ramka kontraktini kelishamiz." },
      { q: "Yetkazib berish qancha vaqt oladi?", a: c.uz.delivery + " Toshkentdagi omborimizdan oʻz transportingiz yoki tashuvchingiz bilan olib ketish ham mumkin." },
      { q: "Uskuna kafolati bilan nima boʻladi?", a: "Ishlab chiqaruvchi kafolati amal qiladi; kafolat holatlarini Toshkent orqali hal qilamiz — almashtirish yoki taʼmirlash bilan. Shartlar kontraktda belgilanadi." },
      { q: "Montaj qilasizmi yoki faqat yetkazasizmi?", a: `Bazaviy — taʼminot va montaj jamoangizni texnik qoʻllab-quvvatlash: sxemalar, sozlash, maslahatlar. Yirik loyihani ishga tushirishga muhandislarimizning ${c.uz.name}ga borishi alohida kelishiladi.` },
    ],
