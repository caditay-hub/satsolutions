...
const UI: Record<string, { home: string; kits: string; includes: string; mount: string; faq: string; forWhom: string; ctaTitle: string; ctaBtn: string; related: string; other: string }> = {
  ...
  uz: { home: "Bosh sahifa", kits: "Toʻplamlar", includes: "Toʻplamga nima kiradi", mount: "Montajga nima kiradi", faq: "Koʻp soʻraladigan savollar", forWhom: "Kim uchun", ctaTitle: "Obyektingiz uchun aniq smeta — bepul", ctaBtn: "Smeta olish", related: "Xizmat haqida batafsil", other: "Boshqa toʻplamlar" },
