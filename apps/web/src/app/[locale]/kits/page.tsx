...
const UI: Record<string, { title: string; desc: string; sub: string; home: string; from: string; more: string }> = {
  ...
  uz: { title: "Narxi bilan tayyor xavfsizlik toʻplamlari", desc: "Uy, doʻkon, ofis va ombor uchun kalit topshirish videokuzatuv va SKUD toʻplamlari: tarkibi, narxi va 1–2 kunda montaj.", sub: "Uskuna + montaj + telefon sozlash. Narx — tipik obyekt uchun; aniq smeta 1 kunda, bepul.", home: "Bosh sahifa", from: "", more: "Batafsil" },
