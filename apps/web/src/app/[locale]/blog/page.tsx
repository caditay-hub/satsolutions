...
const UI: Record<string, { title: string; h1: string; metaTitle: string; subtitle: string; read: string; empty: string; crumbHome: string }> = {
  ...
  uz: { title: "Blog", h1: "Videokuzatuv, SKUD va yongʻin xavfsizligi haqida blog", metaTitle: "Videokuzatuv, SKUD va yongʻin signalizatsiyasi haqida blog — SAT Solutions maqolalari", subtitle: "Videokuzatuv, SKUD, yongʻin signalizatsiyasi va xavfsizlik haqida foydali maqolalar — qanday tanlash, qancha turadi va nimaga eʼtibor berish kerak.", read: "Oʻqish", empty: "Materiallar tez orada paydo boʻladi.", crumbHome: "Bosh sahifa" },
