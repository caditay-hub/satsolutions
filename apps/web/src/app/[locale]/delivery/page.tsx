...
const D: Record<string, {
  ...
  uz: {
    ...
    intro: "Uskunani to'g'ridan-to'g'ri saytda buyurtma qilishingiz mumkin: tovar sahifasida «Buyurtma berish» tugmasini bosing, miqdor va telefonni ko'rsating — menejer ish vaqtida (Du–Ju 9:00–18:00) tasdiqlash uchun bog'lanadi.",
    sections: [
      ...
      { h: "Yetkazib berish", items: [
        ...
        "O'zi olib ketish — Toshkent sh., Katta Darxon ko'chasi, 5 (Du–Ju 9:00–18:00), bepul.",
